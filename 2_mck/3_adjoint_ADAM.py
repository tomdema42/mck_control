# -*- coding: utf-8 -*-
"""
Created on Thu Nov 27 16:12:15 2025
...
# -------------------------------------------------
# 9) Optimization on alpha using Adam
# -------------------------------------------------
if __name__ == "__main__":
    ...
    lr = 10.0          # learning rate (tune if needed)
    beta1 = 0.9
    beta2 = 0.999
    eps_adam = 1e-8
    ...
    print("Adam optimization on alpha (adjoint-based gradient)")
    ...
    for it in range(max_iter):
        ...
        print(f"iter {it:03d} | alpha = {alpha:.6e} | J = {J:.6e} | dJ/dalpha = {dJ:.6e}")
        ...
        alpha_new = alpha - lr * m_hat / (np.sqrt(v_hat) + eps_adam)

        # Project onto [alpha_min, alpha_max]
    ...
    alpha_opt = alpha
    print("\nAdjoint-based optimization result (Adam):")
    ...
    plt.title('Alpha and J vs iteration (Adam)')
    plt.xlim(0, max(80, len(ALPHAS)-1))
    plt.show()
